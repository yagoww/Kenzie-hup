...
function Card({ listTransactions, setListTransactions, transaction, index, FilterNew}) {
  ...
  function delet(){
    ...
    return (
      <li className={transaction.newType === "entrada" ? "list" : "list-s"} key={index} FilterNew={FilterNew}>
